...
unsafe class HelloTriangleApplication
{
    ...
    private void CreateGraphicsPipeline()
    {
        ...
        fixed (byte* pEntrypoint = "main"u8)
        {
            ...
            if (vk.CreatePipelineLayout(device, pipelineLayoutInfo.AsRef(), default, pipelineLayout.AsRef()) !=
                Result.Success)
            {
            ...
            if (vk.CreateGraphicsPipelines(device, default, 1, pipelineInfo.AsRef(), default,
                    graphicsPipeline.AsRef()) != Result.Success)
            {
